...
with st.sidebar:
    brand_html = (
        ...
        '<defs>'
        '<linearGradient id="logoStrokeScreener" '
        ...
        '시장 추세와 위험도를 함께 평가해<br>'
        '1주~1달 관심 종목을 선별하는 대시보드'
        '</div>'
        '</div>'
    )
